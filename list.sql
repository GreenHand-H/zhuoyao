...
INSERT INTO   pet_list VALUES(null,"贪狼",1,"贪狼从西伯利亚的雪原而来，是雪狼神仅存的一支血脉。 “像人类一样，狼群也有严格的等级制度，只有变得更强更快才行。”面对镜头的小贪狼落落大方，面对记者的采访，俨然一个成熟的格斗国际冠军。实际上，他就是。 “但是追求速度就意味着，我永远不会是重量级选手。所以趁我还小的时候，我应该多学习一些招式轻盈的功夫。天下武功，唯快不破。” “我也研究了许多功夫电影，我的偶像是李小龙。”",'tn-name.png',"tn-sm.png","tn-lg.png");
...
INSERT INTO   pet_list VALUES(null,"田螺姑娘",4,"“咦，家里进贼了？”他回来看到这一切，很是疑惑。 “不对啊，我没给过别人钥匙呀……难道是？”目光说着落在了鱼缸里的田螺上。 “不会是传说中的田螺姑娘吧？” “我不信，我要做个辣炒田螺吃……”",'tlgn-name.png',"tlgn-sm.png","tlgn-lg.png");
